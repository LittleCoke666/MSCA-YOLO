...
#     shape_cost = torch.pow(1 - torch.YOLO11n_C3k2_ContextGuidedBlock(YOLO11m_distill)(-1 * omiga_w), 4) + torch.pow(1 - torch.YOLO11n_C3k2_ContextGuidedBlock(YOLO11m_distill)(-1 * omiga_h), 4)
#
...
# def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, MPDIoU=False, feat_h=640, feat_w=640, eps=1e-7):
