...
def increment_path(path: Union[str, Path], exist_ok: bool = False, sep: str = "", mkdir: bool = False) -> Path:
    """
    Increment a file or directory path, i.e., runs/YOLO11n_C3k2_ContextGuidedBlock(YOLO11m_distill) --> runs/YOLO11n_C3k2_ContextGuidedBlock(YOLO11m_distill){sep}2, runs/YOLO11n_C3k2_ContextGuidedBlock(YOLO11m_distill){sep}3, ... etc.
    ...
    Examples:
        ...
        >>> from pathlib import Path
        >>> path = Path("runs/YOLO11n_C3k2_ContextGuidedBlock(YOLO11m_distill)")
        >>> new_path = increment_path(path)
        >>> print(new_path)
        runs/exp2

        Increment a file path:
        >>> path = Path("runs/YOLO11n_C3k2_ContextGuidedBlock(YOLO11m_distill)/results.txt")
        >>> new_path = increment_path(path)
        >>> print(new_path)
        runs/YOLO11n_C3k2_ContextGuidedBlock(YOLO11m_distill)/results2.txt
    """
